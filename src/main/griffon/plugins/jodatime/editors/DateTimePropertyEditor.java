 ...
 */
public class DateTimePropertyEditor extends AbstractPropertyEditor {
    protected void setValueInternal(Object value) {
        if (null == value) {
            ...
            super.setValueInternal(new DateTime(value));
        } else if (value instanceof Date) {
            super.setValueInternal(new DateTime(value));
        } else if (value instanceof Number) {
            super.setValueInternal(new DateTime(((Number) value).longValue()));
        } else {
            throw illegalValue(value, DateTime.class);
        }
    }
    ...
    private void handleAsString(String str) {
        ...
        try {
            super.setValueInternal(new DateTime(Long.parseLong(str)));
            return;
        ...
        try {
            super.setValueInternal(new DateTimeFormatter().parse(str));
        } catch (ParseException e) {
            throw illegalValue(str, DateTime.class, e);
        }
    }
